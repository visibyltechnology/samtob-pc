...
async function middleware(request) {
    ...
    if (!supabaseUrl || !supabaseAnonKey) {
        console.warn("[middleware] NEXT_PUBLIC_SUPABASE_URL / NEXT_PUBLIC_SUPABASE_ANON_KEY are not set — skipping auth session refresh. Add them in your environment (e.g. Vercel -> Project Settings -> Environment Variables) or .env.local.");
        return response;
    }
